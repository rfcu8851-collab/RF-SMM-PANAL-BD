  ...
  const loginWithGoogle = async () => {
    ...
    try {
      ...
      if (userDoc && userData) {
        ...
        currentUserSessionLogin(session);
        showToast(`স্বাগতম, ${session.name}! 🎉`, 'success');
      } else {
          ...
          try {
            ...
            if (refSnap.exists()) {
              ...
              await addDoc(collection(db, 'user_notifications'), {
                uid: referrerUid,
                title: '👥 নতুন রেফারেল মেম্বার জয়েন করেছে!',
                message: `@${finalUsername} (${displayName}) আপনার রেফারেল লিংকের মাধ্যমে Gmail দিয়ে জয়েন করেছে! ৫% লাইফটাইম কমিশন উপভোগ করুন।`,
                type: 'promo',
                timestamp: serverTimestamp(),
                unread: true
              });
        ...
        currentUserSessionLogin(session);
        showToast('Gmail দিয়ে সফলভাবে অ্যাকাউন্ট চালু হয়েছে! 🚀', 'success');
      }
    } catch (e: any) {
      console.error('Google Login error:', e);
      haptic('error');
      if (e?.code === 'auth/popup-closed-by-user') {
        showToast('Google লগইন উইন্ডো বন্ধ করা হয়েছে', 'warning');
      } else if (e?.code === 'auth/network-request-failed') {
        showToast('ইন্টারনেট সংযোগ চেক করুন', 'error');
      } else {
        showToast('Google সাইন ইন ব্যর্থ হয়েছে। আবার চেষ্টা করুন।', 'error');
      }
    } finally {
      setGoogleLoading(false);
    }
                ...
                <div className="mb-4">
                  <div className="flex items-center justify-between">
                    <label className="form-label mb-1 flex items-center gap-1.5">
                      ...
                      <span>Referral Code (রেফারেল কোড - ঐচ্ছিক)</span>
                    </label>
                              ...
                              <div>
                                <div className="flex items-center gap-1.5">
                                  ...
                                  <span className="text-[9px] bg-emerald-500/20 text-emerald-300 px-1.5 py-0.2 rounded font-bold">
                                    Earned ৳{comm.commissionAmount.toFixed(2)}
                                  </span>
                                </div>
                                <div className="text-[10px] text-slate-400 flex items-center gap-2 mt-0.5">
                                  ...
                                  <span>•</span>
                                  <span>Deposit: <strong className="text-amber-300 font-mono">৳{comm.depositAmount}</strong></span>
                                </div>
                              </div>
                            </div>
          ...
          {showNotifModal && (
            <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex flex-col justify-end sm:justify-center p-0 sm:p-4 animate-fade-in">
              <div className="bg-[#0b1329] border border-amber-500/30 rounded-t-3xl sm:rounded-3xl max-h-[85vh] flex flex-col overflow-hidden shadow-[0_0_50px_rgba(245,158,11,0.25)] w-full max-w-lg mx-auto">
                {/* Modal Header */}
                <div className="p-4 border-b border-white/10 flex items-center justify-between bg-slate-900/80">
                  <div clx��Mo���_1Q�J���DCVM���$���� �Khwg���0<4��P=F/�)4�R���P��?�ofvW�˝�%m#m�����y���~o�d����F��cD�0��� ��oz�v��q�ʹ�Z�
um3�?2�� ��t�Z�2�6����`�h5��ZF�ɐ�7�<�)���1�&I�=���it�mK c�qp�Ndׁn���(;)����j[-s��� ���V�N� �L�����겻u�N9e:t}lZb��=@��n�BU�Or1 &BJ.@ܞ���H��c��K䍍m�M�Fm;�tohۚu�:C.�,X��L%��`G)D/�����l3�R�>�,�g[��e$@,0�!��B����������,���%cP�i�ʪp�3�*9L�#�t/�S��/m[@f둂�R}b;�������6qq�_4B�j-�n�X��>�Pf�RfCA�Z��z�N�M�K� J��l���&j ���	�R˴�=�fX�߅WXo���|�,�c[et��Y�����T�U����/�uM�gE'���2��f����gӑ11�a@�c���q~�q5�@਺��B��M"�����n��>�W�g���P@�ֈ�\�l پ3��r�rv:ܵ(e��<�,�-��o@ C���	Vw��h_��4WӫV�+aUS�"l ��&+AmT	D�5����a���C�"�(q/L��
